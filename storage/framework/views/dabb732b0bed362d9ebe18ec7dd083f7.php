            ...
            <div class="container">
                <div class="text-center mb-5">
                    <h2 class="fw-bold text-uppercase">
                        <?php echo e($ppdb->judul ?? 'Pendaftaran Peserta Didik Baru (PPDB)'); ?>

                    </h2>
                    <hr class="mx-auto" style="width:120px;height:4px;background:#22c3b3;border:none;opacity:1;">
                    <p class="text-muted mt-3">
                        <?php echo e($ppdb->deskripsi ?? 'Informasi pendaftaran peserta didik baru tahun ajaran ini.'); ?>
                ...
                <!-- Status -->
                <div class="text-center mb-5">
                    <?php if($ppdb && $ppdb->status == 'Buka'): ?>
                        <span class="badge bg-success fs-6 px-4 py-2">
                            PENDAFTARAN DIBUKA
                        </span>
                    <?php elseif($ppdb && $ppdb->status == 'Tutup'): ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card shadow border-0 h-100">
                            ...
                            <div class="card-body">
                                <?php if($ppdb && $ppdb->jadwal): ?>
                                    <?php echo nl2br(e($ppdb->jadwal)); ?>
                        ...
                        <div class="card shadow border-0 h-100">
                            ...
                            <div class="card-body">
                                <p>
                                    ...
                                    <?php echo e($ppdb->kontak ?? '+62 823 7149 6967'); ?>

                                </p>
                                <hr>
                                <p>
                                    <strong>Email</strong><br>
                                    <?php echo e($ppdb->email ?? 'tkmekartigojangko@gmail.com'); ?>
                ...
                <div class="card shadow border-0 mb-5">
                    ...
                    <div class="card-body">
                        <?php if($ppdb && $ppdb->alur): ?>
                            <?php echo nl2br(e($ppdb->alur)); ?>
                ...
                <div class="text-center mt-4">
                    <a href="<?php echo e(route('ppdb.akun')); ?>" class="btn px-4 py-2 text-white fw-bold"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\tk-mekar-tigo-jangko\resources\views/home.blade.php ENDPATH**/ ?>